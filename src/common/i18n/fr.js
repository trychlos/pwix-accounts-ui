    ...
    ...{
        fr: {
            ...
            user: {
                ...
                signin_error: 'L\'adresse de messagerie et/ou le mot de passe sont invalides, ou l\'utilisateur n\'est pas habilité. Merci de bien vouloir les vérifier.\nEn cas de doute, vous pouvez vous rapprocher de votre administrateur.',
                ...
                verify_error: 'Humm... Désolé, mais il semble que le jeton utilisé ne soit pas ou plus valide.<br />Vous devez en redemander un nouveau.',
