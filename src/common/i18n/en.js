    ...
    ...{
        en: {
            ...
            input_username: {
                ...
                already_exists: 'Username is already in use'
            },
            logged: {
                signout: 'Sign out',
                changepwd: 'Change my password',
            ...
            reset_ask: {
                ...
                textOne: ''
                    +'<p>By clicking on the below "Send" button, we will send an email to the specified email address.'
                    +' This email will include a link which will let you freely change your password.</p>'
                    +'<p>&nbsp;</p>'
            ...
            user: {
                ...
                verify_error: 'Humm... Sorry, but it seems your token is not or no more valid.<br />You have to re-ask for a new verification link.',
                verify_text: 'Hi.<br />Your email address is now said "verified".<br />Thanks.',
                verify_title: 'Email address verification',
                verifyask_error: 'Sorry, it happens that I am unable to send a verification email. Be kind enough to try later.',
                verifyask_success: 'Email successfully sent',
                mandatory_fields: 'Mandatory fields'
            },
            verify_ask: {
                modal_title: 'Re-send verification email',
                textOne: 'By clicking on the below "Send" button, we will send an email to your declared email address.<br />'
