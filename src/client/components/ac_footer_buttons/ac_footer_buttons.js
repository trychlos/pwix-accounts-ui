...
Template.ac_footer_buttons.helpers({
    ...
    buttons(){
        return pwiAccounts.Displayer.buttons( this.me ? this.me : pwiAccounts.Displayer.asked());
    },
    ...
    links(){
        return pwiAccounts.Displayer.links( this.me ? this.me : pwiAccounts.Displayer.asked());
    }
});
